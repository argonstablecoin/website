  ...
  <main class="relative flex flex-col items-center text-center min-h-screen pb-10 md:pb-32">
    ...
    <div class="w-10/12 text-white mt-10 mx-auto text-left font-extralight leading-9 flex flex-col gap-10">
      ...
      <div v-else-if="['US', 'GB'].includes(countryCode)">
        <div class="flex flex-row mb-10">
          ...
          <div class="text-3xl font-medium opacity-70 pr-20 leading-[50px]">
            ...
            <template v-if="countryCode === 'US'">
              the lack of clear crypto regulations within the United States, 
            </template>
        ...
        <div class="LINE LINE2"></div>
        <div class="text-xl opacity-80 mt-10 text-center">Please continue checking back in with us. We hope to bring Argon to the United States as soon as possible. </div>
      </div>
